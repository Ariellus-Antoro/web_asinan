    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('folder_wisata.wisata')" :active="request()->routeIs('folder_wisata.wisata')">
                        {{ __('Tempat Wisata') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('folder_paketWisata.paket_wisata')" :active="request()->routeIs('folder_paketWisata.paket_wisata')">
                        {{ __('Paket Wisata') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('folder_rencana.rencana')" :active="request()->routeIs('folder_rencana.rencana')">
                        {{ __('Rencana') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('folder_setting.setting')" :active="request()->routeIs('folder_setting.setting')">
                        {{ __('Settings') }}
                    </x-nav-link>
                </div>
            </div>
