<x-app-layout>
    <div class="py-4">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-3xl mb-5">Tambah Paket Wisata Baru</h1>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form action="{{ route('folder_paketWisata.store')}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="harga" class="block mt-1 w-full" type="number" name="harga" :value="old('harga')" autofocus />
